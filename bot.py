...
from moviepy.video.io.VideoFileClip import VideoFileClip  # استيراد لحساب مدة الفيديو
import subprocess
import os
import time
import asyncio
...
bot_token = "7484204140:AAFZ0iTmUvPbkzubIsbMabizwCIuYXQ9Nps"  # استبدل بـ توكن البوت الخاص بك
